	...
	<div class="container">
		...
		<form:form commandName="order" class="form-horizontal">
			...
			<div class="form-group">
				...
				<form:input path="cart.customer.firstname" id="name"
					class="form-Control" />
			</div>

			<div class="form-group">
				<label for="email">Email</label>
				<form:input path="cart.customer.email" id="email"
					class="form-Control" />
			</div>

			<div class="form-group">
				<label for="phone">Phone</label>
				<form:input path="cart.customer.phonenumber" id="phone"
					class="form-Control" />
			</div>
			...
			<div class="form-group">
				...
				<form:input path="cart.customer.billingAddress.houseNumber"
