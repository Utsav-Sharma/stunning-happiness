...
app.controller("ProductController", function($scope, $http) {
	...
	$scope.getCart = function(cartId) {
		...
		$http.get('http://localhost:9002/ecom/cart/getCart/'
	...
	$scope.addToCart = function(productId) {
		$http.post('http://localhost:9002/ecom/addCartItem/' + productId)
				.success(function() {
	...
	$scope.removeFromCart = function(cartItemId) {
		...
		$http.put(
				'http://localhost:9002/ecom/cart/removeCartItem/'
	...
	$scope.clearCart = function() {
		$http.put(
				'http://localhost:9002/ecom/cart/removeAllCartItems/'
