	...
	<div ng-app="app" ng-controller="ProductController">
		<div ng-init="getCart(${cartId})">
			...
			<div class="container">
				...
				<div class="col-md-4">
					<a href="#" ng-click="clearCart(${cartItem.cartItemId})"
					...
					<div class="col-md-7  text-left">
						<table class="table table-hover">
							...
							<tr ng-repeat="cartItem in cart.cartItems">
								<td><c:url var="src"
										value="/resources/img/{{cartItem.product.id}}.jpg"></c:url> <img
									class="img-thumbnail" src="${src }" width="120" height="120" /></td>
								<td>{{cartItem.product.name}}</td>
								<td>
									<!-- <button class="btn btn-success" type="button">+</button> -->
									{{cartItem.quantity}} <!-- <button class="btn btn-inverse" type="button">-</button></td> -->
						...
						<h4>
							Total Price : <span class="text-muted">Rs.
